public class String2
{
    ...
    {
        if (s.indexOf("not") != -1 && s.indexOf("bad") != -1 && s.indexOf("not") < s.indexOf("bad"))
        {
            return s.substring(0, s.indexOf("not")) + "good" + s.substring(s.indexOf("bad") + 3);
        }
        return s;
    }
    ...
    {
        int AStart = a.length()%2 == 0 ? a.length()/2 : a.length()/2+1;
        int BStart = b.length()%2 == 0 ? b.length()/2 : b.length()/2+1;

        return a.substring(0, AStart) + b.substring(0, BStart) + a.substring(AStart) + b.substring(BStart);
    }
